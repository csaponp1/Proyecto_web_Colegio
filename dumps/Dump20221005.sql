...
CREATE TABLE `estudiantes` (
  ...
  CONSTRAINT `id_tipo_sangre_tipos_sangre_estudiantes` FOREIGN KEY (`id_tipo_sangre`) REFERENCES `tipos_sangre` (`id_tipo_sangre`) ON DELETE RESTRICT ON UPDATE CASCADE
...
-- Dump completed on 2022-10-05 23:30:14
